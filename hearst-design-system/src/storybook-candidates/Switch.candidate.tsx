...
// Not indexed: Switch has no current application route or application import site.
...
const meta: Meta<typeof Switch> = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Candidate binary-setting primitive using the current semantic primary, input, background, destructive, and ring roles. Promote only with a production use site and an explicitly associated label.",
      },
    },
  },
};
